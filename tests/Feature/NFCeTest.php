...
{
    public function testCanCreateNFCe()
    {
        $response = $this->bling->nfces()->create([
            'pedido' => [
                'cliente' => [
    ...
    public function testCanListNFCes()
    {
        $response = $this->bling->nfces()->all([
    ...
    public function testCanFindNFCe()
    {
        $response = $this->bling->nfces()->find(1, 1);
    ...
    public function testCanSendNFCe()
    {
        $response = $this->bling->nfces()->send(1, 1);
